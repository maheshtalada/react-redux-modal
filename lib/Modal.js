...
var Modal = function (_Component) {
  ...
  function Modal(props) {
    ...
    _this.forceCloseModal = _this.forceCloseModal.bind(_this);
  ...
  Modal.prototype.forceCloseModal = function forceCloseModal() {
    this.props.removeModal(this.props.id);
    //allowing the background page to scroll as usual when modal closes
    document.documentElement.classList.remove('no-scroll');
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'rrm-body' },
            _react2.default.createElement(this.props.component, _extends({ key: this.state.title }, this.props.options, this.props.data, { removeModal: this.closeModal, updateModalTitle: this.updateTitle }))
          )
        )
      ),
